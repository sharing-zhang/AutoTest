...
enum URL {
    # list = '/myapp/admin/CheckConfigTime/list',
    # create = '/myapp/admin/CheckConfigTime/create',
    # update = '/myapp/admin/CheckConfigTime/update',
    # delete = '/myapp/admin/CheckConfigTime/delete',
    # detail = '/myapp/admin/CheckConfigTime/detail',
